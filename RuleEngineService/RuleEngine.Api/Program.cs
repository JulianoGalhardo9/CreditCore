...
var connectionString = "Server=sqlserver,1433;Database=RuleEngineDb;User Id=SA;Password=SuaSenhaForte123!;TrustServerCertificate=True";
...
{
    var db = scope.ServiceProvider.GetRequiredService<RuleEngine.Infrastructure.Data.AppDbContext>();
    db.Database.Migrate();
}
